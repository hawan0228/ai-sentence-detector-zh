...
資料由本人從不同平台蒐集，並自行透過 prompt 調適與 prompt engineering 產生及整理 AI 文本。AI 語料使用過 GPT-4o、GPT-4.5、GPT-4 Turbo、Gemini 1.0 Ultra、Gemini 1.5 Pro、Claude 3.5、Llama 3.1 與 Gemma 等模型系列。
